...
import { Loader2, Mail, Lock, Eye, EyeOff, ArrowLeft, MessageSquare, AlertTriangle, Sparkles } from "lucide-react";
            ...
            <CardContent className="p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-sm mb-2">💡 Modo Demo Disponível</h3>
                  <p className="text-xs text-muted-foreground mb-3">
                    Use estas credenciais para testar sem conexão com Supabase:
                  </p>
                  <div className="space-y-2">
                    {DEMO_USERS.map((demoUser) => (
                      <div
                        key={demoUser.id}
                        className="text-xs bg-background/50 p-2 rounded border cursor-pointer hover:bg-background/80 transition-colors"
                        onClick={() => {
                      ...
                      >
                        <div className="font-mono">
                          <span className="font-semibold">{demoUser.email}</span>
